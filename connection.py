    ...
    #   while not self.client.bitfield.all(True):
        ...
        #    print(self.client.bitfield.bin)
            for i in range(self.client.metainfo.num_pieces):
                    ...
                    if message_id == 7:
                        ...
                        if (piece_hash == self.client.metainfo.get_piece_hash(int_index)):
                            ...
                            if(piece):
                                ...
                                print(self.client.bitfield.bin)
                                print("bitfield length", len(self.client.bitfield.bin))
                        ...
                        #if(len(self.client.bitfield.bin) == )
                        self.peer_bitfield = BitArray(message[5:6+len(self.peer_bitfield)])
                ...
                print("Would reassemble file here")
                break
